...
export default function RepoPage({ params }: RepoPageProps) {
  ...
  const [resolvedParams, setResolvedParams] = useState<{ owner: string; name: string } | null>(null)
    ...
    const fetchRepoData = async () => {
      ...
      try {
        const res = await fetch('/api/repo', {
          ...
          body: JSON.stringify({ repoUrl: `${resolvedParams.owner}/${resolvedParams.name}` }),
        })
